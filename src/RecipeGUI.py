...
def opens_new_window():
    ...
    tk.Label(form_frame, text="Recipe Name:", bg="#f0f0f0").grid(
    ...
    tk.Label(form_frame, text="Ingredients:", bg="#f0f0f0").grid(
    ...
    tk.Label(form_frame, text="Instructions:", bg="#f0f0f0").grid(
...
tk.Label(allergy_frame, text="Filter by Dietary Restrictions:", bg="#ffffff").pack(
    pady=5
)
...
scrollbar = tk.Scrollbar(
    results_frame, orient=tk.VERTICAL, command=results_text_widget.yview
)
...
# selects recipes and displays their instructions
...
# when selecting recipe, this saves it to pass to fnc in recipe logic
...
add_recipe_button = Button(
    button_frame1, text="Add New Recipe", command=opens_new_window
)
...
save_list_button = Button(
    button_frame2, text="Save Ingredients", command=save_selected_recipe
)
save_list_button.pack(side=tk.LEFT, padx=5, pady=5)
clear_list_button = Button(
    button_frame2, text="Clear Grocery List", command=RecipeLogic.clear_grocery_list
)
clear_list_button.pack(side=tk.LEFT, padx=5, pady=5)
generate_list_button = Button(
    button_frame2,
    text="Generate Grocery List",
    command=RecipeLogic.generate_grocery_list,
)
